...
`··········` 0% · 0 of 7 done · due 2027-03-15

Three ways of looking at one backlog, that behave like one program.

### backlog

- [ ] `0056` What a lens is, and what must be true of every one <sup>spike · p1 · chrome</sup>
...
- [ ] `0061` The stats pane answers the mouse <sup>feature · p2 · chrome</sup>
